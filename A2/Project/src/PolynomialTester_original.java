...
public class PolynomialTester_original {
    ...
    private static void testClone() {
        ...
        if (clone.checkEqual(poly)) {
            ...
            return;///Modify and check if dif and create 2 pointers check if dif; clone empty or size=1
        }
        System.out.println("Failed: deepClone()");
    }

    // Tests if the terms are arranged in correct order.
    private static void testAddTerm_1()///test all 3cases; added one is 0; add is head/tail
    {
    ...
    private static void testAdd_1()///check if original changes
    {
        Polynomial p1 = new Polynomial();
        Polynomial p2 = new Polynomial();
    ...
    private static void testAdd_2() {
        ...
        p3.addTerm(new Term(2, new BigInteger("-2")));
        p3.addTerm(new Term(0, new BigInteger("-1")));
        p3.addTerm(new Term(3, new BigInteger("-1")));
        p3.addTerm(new Term(4, new BigInteger("2")));
    ...
    private static void testMultiply()///test coe=0
    {
        Polynomial p1 = new Polynomial();
        Polynomial p2 = new Polynomial();
        Polynomial p3 = new Polynomial();
        Polynomial p4;
        p3.addTerm(new Term(0,BigInteger.valueOf(0)));
